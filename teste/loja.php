...
<main>
    ...
    <div class="container">
        <div class="row align-items-center flex-wrap flex-lg-nowrap gap-sm-3 gap-0">
            <select class="col-md-3 col-lg-2 col-5 form-select border-0" aria-label="Default select example">
                <option selected>Ordenar</option>
                <option value="1">exemplo</option>
                <option value="2">exemplo</option>
                <option value="3">exemplo</option>
            </select>
            <p class="col-2 text-muted text-nowrap mb-0"> Mostar 1-4 de 30 resultados</p>
            <nav aria-label="col-5 Page navigation">
                <ul class="pagination fw-bold ps-0 ps-lg-4 ps-xl-0">
    ...
    <section>
        <div class="container mt-5">
            <div class="row">
                <div class="order-md-1 col-12 col-md-4 d-flex flex-column filter-range mb-5 mb-md-3">
                    ...
                    <p class="mb-0 mt-2 text-muted">Preço: <i class="bi bi-currency-dollar me-2"></i>20 -  <i class="bi bi-currency-dollar me-2"></i>1399</p>
    ...
    <div class="container my-5">
        <div class="row align-items-center flex-wrap flex-xl-nowrap gap-sm-3 gap-0">
            <select class="col-md-3 col-lg-2 col-5 form-select border-0" aria-label="Default select example">
                <option selected>Ordenar</option>
                <option value="1">exemplo</option>
                <option value="2">exemplo</option>
